...
enum opt_code
{
  ...
  OPT_flifetime_dse = 711,                   /* -flifetime-dse */
  ...
  OPT_mabi_ = 1069,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1070,             /* -mabort-on-noreturn */
  OPT_mapcs = 1071,                          /* -mapcs */
  OPT_mapcs_float = 1072,                    /* -mapcs-float */
  OPT_mapcs_frame = 1073,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1074,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1075,              /* -mapcs-stack-check */
  OPT_march_ = 1076,                         /* -march= */
  OPT_marm = 1077,                           /* -marm */
  OPT_mbig_endian = 1078,                    /* -mbig-endian */
  ...
  OPT_munaligned_access = 1109,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1110,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1111,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1112,              /* -mword-relocations */
  OPT_mwords_little_endian = 1113,           /* -mwords-little-endian */
  OPT_n = 1114,                              /* -n */
  OPT_no_canonical_prefixes = 1115,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1116,              /* -no-integrated-cpp */
  OPT_nocpp = 1117,                          /* -nocpp */
  OPT_nodefaultlibs = 1118,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1119,                   /* -nostartfiles */
  OPT_nostdinc = 1120,                       /* -nostdinc */
  OPT_nostdinc__ = 1121,                     /* -nostdinc++ */
  OPT_nostdlib = 1122,                       /* -nostdlib */
  OPT_o = 1123,                              /* -o */
  OPT_p = 1124,                              /* -p */
  OPT_pass_exit_codes = 1125,                /* -pass-exit-codes */
  /* OPT_pedantic = 1126, */                 /* -pedantic */
  OPT_pedantic_errors = 1127,                /* -pedantic-errors */
  OPT_pg = 1128,                             /* -pg */
  OPT_pie = 1129,                            /* -pie */
  OPT_pipe = 1130,                           /* -pipe */
  OPT_print_file_name_ = 1131,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1132,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1133,          /* -print-multi-directory */
  OPT_print_multi_lib = 1134,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1135,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1136,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1137,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1138,               /* -print-prog-name= */
  OPT_print_search_dirs = 1139,              /* -print-search-dirs */
  OPT_print_sysroot = 1140,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1141,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1142,                          /* -quiet */
  OPT_r = 1143,                              /* -r */
  ...
  OPT_shared = 1149,                         /* -shared */
  OPT_shared_libgcc = 1150,                  /* -shared-libgcc */
  /* OPT_specs = 1151, */                    /* -specs */
  OPT_specs_ = 1152,                         /* -specs= */
  OPT_static = 1153,                         /* -static */
  OPT_static_libasan = 1154,                 /* -static-libasan */
  OPT_static_libgcc = 1155,                  /* -static-libgcc */
  OPT_static_libgcj = 1156,                  /* -static-libgcj */
  OPT_static_libgfortran = 1157,             /* -static-libgfortran */
  OPT_static_libgo = 1158,                   /* -static-libgo */
  OPT_static_liblsan = 1159,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1160,               /* -static-libstdc++ */
  OPT_static_libtsan = 1161,                 /* -static-libtsan */
  OPT_static_libubsan = 1162,                /* -static-libubsan */
  /* OPT_std_c__03 = 1163, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1164, */                /* -std=c++0x */
  OPT_std_c__11 = 1165,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1166, */                /* -std=c++14 */
  OPT_std_c__1y = 1167,                      /* -std=c++1y */
  OPT_std_c__98 = 1168,                      /* -std=c++98 */
  OPT_std_c11 = 1169,                        /* -std=c11 */
  /* OPT_std_c1x = 1170, */                  /* -std=c1x */
  /* OPT_std_c89 = 1171, */                  /* -std=c89 */
  OPT_std_c90 = 1172,                        /* -std=c90 */
  OPT_std_c99 = 1173,                        /* -std=c99 */
  /* OPT_std_c9x = 1174, */                  /* -std=c9x */
  OPT_std_f2003 = 1175,                      /* -std=f2003 */
  OPT_std_f2008 = 1176,                      /* -std=f2008 */
  OPT_std_f2008ts = 1177,                    /* -std=f2008ts */
  OPT_std_f95 = 1178,                        /* -std=f95 */
  OPT_std_gnu = 1179,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1180, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1181, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1182,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1183, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1184,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1185,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1186,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1187, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1188, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1189,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1190,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1191, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1192, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1193,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1194, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1195, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1196, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1197,                     /* -std=legacy */
  ...
  OPT_u = 1205,                              /* -u */
  OPT_undef = 1206,                          /* -undef */
  OPT_v = 1207,                              /* -v */
  OPT_version = 1208,                        /* -version */
  OPT_w = 1209,                              /* -w */
  OPT_wrapper = 1210,                        /* -wrapper */
  OPT_x = 1211,                              /* -x */
  OPT_z = 1212,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
