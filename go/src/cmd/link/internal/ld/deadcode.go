...
func (d *deadcodePass) init() {
	...
	if d.ctxt.HeadType == objabi.Hqnx {
		// DT_INIT target and the DT_INIT_ARRAY/DT_FINI_ARRAY backing array —
		// referenced only from the dynamic section, so keep them alive.
		names = append(names, "runtime.qnxInit", "runtime.qnxInitArray")
	}
