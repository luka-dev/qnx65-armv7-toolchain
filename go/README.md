...
## [ok] MILESTONE 3 COMPLETE (2026-07) - Go RUNS on QNX 6.5 armv7
...
## [ok] MILESTONE 4 (2026-07) - syscall + os (files) + netpoll, HARDWARE-VERIFIED
...
## [ok] MILESTONE 5 (2026-07) - net + crypto/tls + net/http COMPILE, net path runs on HW
...
## [ok] MILESTONE 6 (2026-07) - VALIDATED ON THE REAL MHI2q HEAD UNIT; full std builds
...
## [ok] MILESTONE 7 (2026-07) - TAILSCALE DAEMON RUNS ON THE AUDI HEAD UNIT
...
## [ok] MILESTONE 8 (2026-07) - interface enumeration + network time; daemon brings the network UP
